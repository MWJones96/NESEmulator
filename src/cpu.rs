...
impl CPU {
    ...
    fn fetch_addr_mode(&mut self, opcode: u8, bus: &impl CPUBus) -> AddrModeResult {
        match opcode {
            ...
            | 0x7E | 0xFD | 0x9D | 0xDF | 0xFF | 0x1C | 0x3C | 0x5C | 0x7C | 0xDC | 0xFC => {
                let abs_addr = self.fetch_two_bytes_as_u16(bus);
            ...
            0x61 | 0x21 | 0xC1 | 0x41 | 0xA1 | 0x01 | 0xE1 | 0x81 | 0xC3 | 0xE3 | 0xA3 => {
            ...
            0x71 | 0x31 | 0xD1 | 0x51 | 0xB1 | 0x11 | 0xF1 | 0x91 | 0xD3 | 0xF3 | 0xB3 => {
                let addr = self.fetch_byte(bus);
                self.indy(addr, bus)
            }
