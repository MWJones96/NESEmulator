...
impl CPU {
    ...
    fn fetch_addr_mode(&mut self, opcode: u8, bus: &impl CPUBus) -> AddrModeResult {
        match opcode {
            ...
            | 0x2B | 0x6B | 0x4B | 0xAB | 0x80 | 0x82 | 0x89 | 0xC2 | 0xE2 | 0xEB | 0xCB | 0x8B => {
            ...
            | 0xEF | 0xAF | 0x0C | 0x2F | 0x6F | 0x8F | 0x0F | 0x4F => {
            ...
            | 0xBF | 0x3B | 0x7B | 0x9F | 0x9B | 0x9E | 0x1B | 0x5B => {
                let abs_addr = self.fetch_two_bytes_as_u16(bus);
            ...
            | 0x04 | 0x44 | 0x64 | 0x27 | 0x67 | 0x87 | 0x07 | 0x47 => {
                let addr = self.fetch_byte(bus);
                self.zp(addr, bus)
            }
    ...
    fn get_number_of_cycles(&self, opcode: u8, mode: &AddrModeResult) -> u8 {
        match opcode {
            ...
            0x0F | 0x1F | 0x1B | 0x07 | 0x17 | 0x03 | 0x13 => self.slo_cycles(mode),
            ...
            0x4F | 0x5F | 0x5B | 0x47 | 0x57 | 0x43 | 0x53 => self.sre_cycles(mode),
            ...
            0x6F | 0x7F | 0x7B | 0x67 | 0x77 | 0x63 | 0x73 => self.rra_cycles(mode),
            ...
            0xE9 | 0xEB | 0xED | 0xFD | 0xF9 | 0xE5 | 0xF5 | 0xE1 | 0xF1 => self.sbc_cycles(mode),
